...
class UserController extends Controller
{
   ...
   // Ambil data user dalam bentuk json untuk datatables
    public function list(Request $request)
    {
        ...
        // Filter data user berdasrakna level_id
        if ($request->level_id) {
        ...
        return DataTables::of($users)
            ...
            ->addColumn('aksi', function ($user) { // menambahkan kolom aksi
                ...
                $btn .= '<form class="d-inline-block" method="POST" action="'.url('/user/'.$user->user_id).'">'
                    ...
                    confirm(\'Apakah Anda yakin menghapus data ini?\');">Hapus</button>'
                    . '</form>';*/
    ...
    public function edit(string $id)
    {
     ...
     public function destroy(string $id)
     {
        ...
        if (!$check) {      // Unutk mengecek apakah data user dengan id yang dimaksud ada atau tidak
     ...
     // Menampilkan halaman form tambah Ajax
     ...
     public function store_ajax(Request $request) {
        ...
        return response()->json([
            'status'    => true,
            'massage'   => 'Data user berhasil disimpan'
        ]);
        }
        redirect('/');
     }
